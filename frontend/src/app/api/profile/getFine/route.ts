...
/**
 * Get user fine route
 * @description This route is used to get the user's fine
...
export async function POST(request: NextRequest) {
    /**
     * Get user fine
     * @description This function gets the user's fine from the database
    ...
    try {
       ...
       return NextResponse.json({ balance: user.fines }, { status: 200 }); // Return the user's fine
